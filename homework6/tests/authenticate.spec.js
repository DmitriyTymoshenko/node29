...
describe('Middleware authenticate', () => {
  ...
  it('Work correctly', async () => {
    req = {
      headers: { authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxNmE4YWJmZjRkMWFlYjVlYTQ0ZjA2MSIsImlhdCI6MTYzNDM3NDc5Nn0.nyyKogdo915DAwKdAxwNQFhtTcrbR8UDq7OLlOQWkIc', }
    }
    const user = {
